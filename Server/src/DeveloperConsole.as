...
package 
{
	...
	public class DeveloperConsole extends Sprite
	{
		...
		// Constructor
		public function DeveloperConsole(_main:*, Main2:PlayState)
		{
		...
		private function showSuggestions(str:String):void
		{
			...
			if (str != "")
			{
				...
				{
					// FIND ME
					var ob:* = stringToVarWithCalculation(str, main2, true);
		...
		private function changeVar(varname:String, vset:*):void
		{
			try
			{
				...
				if (!assignVar(varname, vset, v, main2))
					throw new Error();
			}
			catch (er:Error)
			{
