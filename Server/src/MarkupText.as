package 
{
	...
	public class MarkupText extends FlxText
	{
		 ...
		 * @param 	Autowidth		Wether this text field has its width set automatically (for one liners)
		 * @param	Markups			Array of markup objects, or an empty array if you wish.
		 */
		public function FlxText(X:Number, Y:Number, Width:uint, Text:String=null, EmbeddedFont:Boolean=true, Autowidth:Boolean = false, Markup:Array = [])
		{
